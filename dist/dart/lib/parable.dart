...
class Word implements Node {
  ...
  List<int> _ansiCToBytes(String inner) {
    ...
    while (i < inner.length) {
      if ((inner[i]).toString() == "\\" && i + 1 < inner.length) {
            ...
            if (c == "x") {
              if (i + 2 < inner.length && (inner[i + 2]).toString() == "{") {
                ...
                if (j > i + 2) {
                  ...
                  result.add((((inner[i]).toString()[0] as int) as int));
                  i += 1;
                }
              }
            } else {
              ...
              if (c == "u") {
                ...
                if (j > i + 2) {
                  ...
                  result.addAll(String.fromCharCode(codepoint).codeUnits);
                  i = j;
                } else {
                  result.add((((inner[i]).toString()[0] as int) as int));
                  i += 1;
        ...
        result.addAll((inner[i]).toString().codeUnits);
        i += 1;
      }
    }
    return result;
  ...
  String _normalizeArrayInner(String inner) {
    ...
    return normalized.join("").trimRight();
  }
      ...
      if (ch == "(") {
        ...
        if (ch == ")") {
          if (parenDepth > 0) {
            ...
            if (this.pos + 1 < this.length && (this.source[this.pos + 1]).toString() == ")") {
              parts.add(current.join("").trimLeft());
              this.advance();
              this.advance();
              break;
            } else {
