...
class FuzzerFixer:
    ...
    def run(self) -> int:
        ...
        self._write_summary(f"## Fuzzer Agent\n\n| | |\n|---|---|\n| **Model** | `{self.model_name}` |\n| **Base SHA** | `{base_sha}` |\n")
        ...
        try:
            ...
            self.log.info("agent_complete", duration=round(duration, 2), input_tokens=input_tokens, output_tokens=output_tokens, cost=round(cost, 4))
