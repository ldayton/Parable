...
Python to JavaScript/Go transpiler for Parable. TypeScript definitions are auto-generated from the transpiled JS.
...
# Transpile parable.py to Go
uv run transpiler --transpile-go src/parable.py > src/parable.go
