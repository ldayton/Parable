...
class GoTranspiler(NamingMixin, TypeSystemMixin, SymbolsMixin, EmitExpressionsMixin, EmitStatementsMixin, ScopeAnalysisMixin, EmitStructureMixin, ast.NodeVisitor):
